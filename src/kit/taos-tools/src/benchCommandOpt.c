...
#define BENCH_RAND_SEED  "Random seed for the rand data generator, default is 1."
...
static struct argp_option bench_options[] = {
    ...
    {"rand-seed", 's', "NUMBER", 0, BENCH_RAND_SEED},
...
static int32_t bench_parse_single_opt(int32_t key, char* arg) {
    ...
    switch (key) {
        ...
        case 'd':
            ...
            break;
        case 's':
            g_arguments->rand_seed = atoi(arg);
            break;
        case 'l':
            g_arguments->demo_mode = false;
